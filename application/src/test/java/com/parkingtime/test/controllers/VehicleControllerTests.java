...
import com.parkingtime.controllers.VehicleController;
...
class VehicleControllerTests {
    ...
    void createVehicle_createUserNewVehicle_shouldReturn201CreatedStatusCode() throws Exception {
        long userId = 1L;
    ...
    void getVehicle_getUserVehicle_shouldReturn200OkStatusCode() throws Exception {
        long vehicleId = 1L;
        String licencePlate = "ABCD123";
    ...
    void getVehicleByLicencePlate_getUserVehicleByLicencePlate_shouldReturn200OkStatusCode() throws Exception {
        long vehicleId = 1L;
        String licencePlate = "ABCD123";
    ...
    void deleteVehicle_deleteUserVehicle_shouldReturn202AcceptedStatusCode() throws Exception {
        long vehicleId = 1L;
